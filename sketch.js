...
function preload(){
  trex_running = loadAnimation("1d.png", "2d.png","3d.png","4.png");
  
  trex_collided = loadAnimation("slip.png");
...
function setup() {
  ...
  trex.setCollider('rectangle', 0, 0, 35,trex.height);
  //trex.debug = true;
  ...
  score = 0;
  gameOver=createSprite(317,66,20,20);
  gameOver.addImage(gameImage)
  restart=createSprite(320,110,10,10);
